...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(326, 457)
        self.groupBox = QtWidgets.QGroupBox(Dialog)
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 301, 441))
        self.groupBox.setObjectName("groupBox")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.groupBox)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(60, 180, 181, 41))
        ...
        self.rolelable = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
        self.rolelable.setObjectName("rolelable")
        self.no2.addWidget(self.rolelable)
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(90, 280, 151, 41))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(90, 230, 151, 41))
        ...
        self.horizontalLayoutWidget_5.setGeometry(QtCore.QRect(60, 330, 181, 41))
        ...
        self.registerBtn.setGeometry(QtCore.QRect(100, 390, 93, 28))
        self.registerBtn.setObjectName("registerBtn")
        self.picLable = QtWidgets.QLabel(self.groupBox)
        self.picLable.setGeometry(QtCore.QRect(0, 20, 301, 101))
        self.picLable.setText("")
        self.picLable.setPixmap(QtGui.QPixmap("image/teacher.png"))
        self.picLable.setScaledContents(True)
        self.picLable.setObjectName("picLable")
        self.label = QtWidgets.QLabel(self.groupBox)
        self.label.setGeometry(QtCore.QRect(60, 130, 86, 49))
        self.label.setObjectName("label")
        self.comboBox = QtWidgets.QComboBox(self.groupBox)
        self.comboBox.setGeometry(QtCore.QRect(140, 140, 101, 31))
        font = QtGui.QFont()
        font.setFamily("新宋体")
        ...
        self.comboBox.setStyleSheet("background-color: rgb(129, 215, 255);\n"
                                        "font: 11pt \"新宋体\";")
        ...
        self.warnning.setGeometry(QtCore.QRect(220, 370, 81, 61))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox.setTitle(_translate("Dialog", "用户注册"))
        self.rolelable.setText(_translate("Dialog", "教工编号"))
        ...
        self.label.setText(_translate("Dialog", "用户身份"))
        self.comboBox.setItemText(0, _translate("Dialog", "教师"))
